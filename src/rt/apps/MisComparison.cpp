...
void MisComparisonApp::run() {
	...
	auto mirror_1 = std::make_shared<Metal>(glm::vec3(0.95), 0.07); // Slightly Rough
	auto mirror_2 = std::make_shared<Metal>(glm::vec3(0.95), 0.11); // Rough
	auto mirror_3 = std::make_shared<Metal>(glm::vec3(0.95), 0.15); // Very Rough

	// Light Material
	auto light_mat = std::make_shared<DiffuseLight>(glm::vec3(60, 60, 60));
	...
	// Spheres
	auto red_sphere = std::make_shared<Sphere>(glm::vec3(-150, 400, 280), 5, red);
	auto blue_sphere = std::make_shared<Sphere>(glm::vec3(-50, 400, 280), 15, blue);
	auto green_sphere = std::make_shared<Sphere>(glm::vec3(50, 400, 280), 25, green);
	auto yellow_sphere = std::make_shared<Sphere>(glm::vec3(150, 400, 280), 45, yellow);
	...
	// Light
	auto light_shape = std::make_shared<Quad>(glm::vec3(-60, 340, -450), glm::vec3(0, 120, 0), glm::vec3(120, 0, 0), light_mat);
